...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == backingArray.length) {
            ...
            for (int x = 0; x < backingArray.length; x++) {
                backingArray2[x + 1] = backingArray[mod(front + x, backingArray.length)];
            }
    ...
    public void addLast(T data) {
        ...
        if (size == backingArray.length) {
            T[] backingArray2 = (T[]) new Object[backingArray.length * 2];
            for (int x = 0; x < backingArray.length; x++) {
                backingArray2[x] = backingArray[mod(front + x, backingArray.length)];
            }
            backingArray = backingArray2;
            front = 0;
        }
        backingArray[mod(size + front, backingArray.length)] = data;
        size++;
    }
    ...
    public T getFirst() {
        ...
        return (T) backingArray[mod(front, backingArray.length)];
    }
    ...
    public T getLast() {
        ...
        return (T) backingArray[mod(front + size - 1, backingArray.length)];
    }
